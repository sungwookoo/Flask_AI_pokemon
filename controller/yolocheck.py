def yolo():
	...
	from keras.preprocessing.image import load_img #이미지를 PIL형식으로 로드.
	...
	photo_filename = 'static/uploads/temp.jpg'
	...
	"diningtable":"torterra", "toilet":"weepinbell", "tv monitor":"charjabug", "laptop":"torkoal", "mouse":"dedenne",
	"remote":"umbreon", "keyboard":"Kyogre", "cell phone":"mewtwo", "microwave":"rotom",
	 "oven":"paras", "toaster":"snorlax", "sink":"gyarados", "refrigerator":"meltan", "book":"slowpoke" ,"clock":"noctowl",
	 "vase":"venusaur", "scissors":"scizor", "teddy bear":"teddiursa", "hair drier":"bellsprout", "toothbrush":"poliwag"}
